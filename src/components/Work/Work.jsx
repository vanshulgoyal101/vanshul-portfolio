...
const experiences = [
  ...
  },
  {
    ...
    description: 'Automated the end-to-end sign-up process for healthcare providers, and built a drag-and-drop email editor used by 1,500+ healthcare organisations to reach over 2M patients.',
