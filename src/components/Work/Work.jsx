...
const experiences = [
  {
    ...
    description: 'Contributing to airport operations systems and processes at one of the world\'s leading airlines. Working on optimising critical aviation systems and improving operational efficiency.',
