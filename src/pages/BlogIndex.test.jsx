...
describe('BlogIndex', () => {
  it('sets a blog-specific document title and canonical', async () => {
    await renderPage();
  ...
  it('lists every published post with a link to its page', async () => {
    await renderPage();
  ...
  it('emits Blog + BreadcrumbList structured data covering all posts', async () => {
    await renderPage();
