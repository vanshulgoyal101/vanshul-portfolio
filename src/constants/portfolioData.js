...
export const bioData = {
  ...
  email: "vanshulgoyal101@gmail.com", // standard contact placeholder or fallback
  ...
  achievements: [
    ...
    { number: "State", label: "Level Representative in Cricket, Softball & Baseball" },
...
export const chatbotKnowledge = {
  welcomeMessage: "Hey! I'm AI Vanshul, a virtual conversational agent. Ask me anything about Solaride, NASA HERC, aviation operations, my favorite books, travel stories, or philosophy!",
  defaultSuggestions: [
    "Tell me about Solaride.",
    "What was the NASA Rover challenge?",
